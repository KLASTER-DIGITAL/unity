 ...
 */
export function EntryCard({ entry, index, onOpenActions, onDelete }: EntryCardProps) {
      ...
      <SwipeableCard enabled={!!onDelete} onDelete={handleDelete}>
        <AnimatedPressable enableHaptics={false} style={styles.card}>
          ...
          <View style={styles.header}>
            ...
            <Pressable onPress={() => onOpenActions(entry)} style={styles.moreButton}>
          ...
          <View style={styles.footer}>
            <View
              style={[
                ...
                { backgroundColor: sentimentColor.bg, borderColor: sentimentColor.text },
              ]}
            >
              <Text style={[styles.sentimentText, { color: sentimentColor.text }]}>
                {sentimentLabel}
              </Text>
            </View>
