...
- **Упоминания**: Только в `docs/plan/tasks/planned/ecosystem-expansion.md`
- **Навигация**: Отсутствует в `MobileBottomNav.tsx`

### Привычки (Habits)
- **Статус**: Не реализовано
- **Упоминания**: Только в планах
...
**Рекомендация**: Удалить упоминания из документации или добавить в roadmap с четкими сроками.
...
### Важные (P1):
4. ❌ **Добавить разделы Goals/Habits/Tasks** - ИЛИ удалить из документации
5. 🔄 **Продолжить lint cleanup** - 7,229 проблем осталось
6. 📝 **Обновить документацию** - убрать упоминания нереализованных разделов
