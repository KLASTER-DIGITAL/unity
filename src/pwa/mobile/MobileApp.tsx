...
const importAchievementHomeScreen = () =>
  import('@/features/mobile/home').then((module) => ({ default: module.AchievementHomeScreen }));
const importHistoryScreen = () =>
  import('@/features/mobile/history').then((module) => ({ default: module.HistoryScreen }));
...
const importReportsScreen = () =>
  import('@/features/mobile/reports').then((module) => ({ default: module.ReportsScreen }));
const importSettingsScreen = () =>
  import('@/features/mobile/settings').then((module) => ({ default: module.SettingsScreen }));
