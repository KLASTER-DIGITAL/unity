	...
	return (
		<>
			...
			>
				...
				<p className="mb-4 text-footnote text-muted-foreground">Часто задаваемые вопросы</p>

				<Accordion className="w-full" collapsible type="single">
					<AccordionItem value="item-1">
						<AccordionTrigger>Как создать запись в дневнике?</AccordionTrigger>
						<AccordionContent>
							Нажмите кнопку "+" на главном экране, опишите ваше достижение или неудачу, и AI
							автоматически проанализирует запись.
						</AccordionContent>
					</AccordionItem>
					<AccordionItem value="item-2">
						<AccordionTrigger>Как работает AI-анализ?</AccordionTrigger>
						<AccordionContent>
							AI анализирует вашу запись, определяет тип события (достижение/неудача), эмоциональный
							тон и создает мотивационную карточку с советами.
						</AccordionContent>
					</AccordionItem>
					<AccordionItem value="item-3">
						<AccordionTrigger>Что такое мотивационные карточки?</AccordionTrigger>
						<AccordionContent>
							Это персонализированные сообщения от AI, которые помогают вам развивать полезные
							привычки на основе ваших записей.
						</AccordionContent>
					</AccordionItem>
					<AccordionItem value="item-4">
						<AccordionTrigger>Как получить премиум-доступ?</AccordionTrigger>
						<AccordionContent>
							Премиум-функции включают дополнительные темы, автоматическое резервирование и
							расширенную аналитику. Свяжитесь с поддержкой для подключения.
						</AccordionContent>
					</AccordionItem>
					<AccordionItem value="item-5">
						<AccordionTrigger>Как экспортировать данные?</AccordionTrigger>
						<AccordionContent>
							Перейдите в Настройки → Дополнительно → Экспортировать данные. Доступны форматы JSON,
							CSV и ZIP.
						</AccordionContent>
					</AccordionItem>
				</Accordion>
