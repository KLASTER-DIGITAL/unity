...
export const translations = {
	ru: {
		...
		validationError:
			"Пожалуйста, введите название дневника или выберите готовый вариант",
	},
	en: {
	...
	es: {
		...
		validationError:
			"Por favor, ingresa un nombre para el diario o elige una opción",
	},
	de: {
		...
		validationError:
			"Bitte gib einen Tagebuchnamen ein oder wähle eine Vorlage",
	},
	fr: {
