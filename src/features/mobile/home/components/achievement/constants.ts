	...
	es: [
		{
			...
			description:
				"Escribe una pequeña victoria — es el primer paso para reconocer tus logros.",
			gradient:
				"from-[var(--gradient-positive-1-start)] to-[var(--gradient-positive-1-end)]",
			isMarked: false,
		},
		{
			...
			description:
				"No tienes que escribir mucho — una frase puede cambiar tu perspectiva del día.",
			gradient:
				"from-[var(--gradient-positive-3-start)] to-[var(--gradient-positive-3-end)]",
			isMarked: false,
		},
	...
	ja: [
		{
			...
			title: "今日は良い時です",
			description:
				"小さな勝利を書き留めましょう——それはあなたの成果を認識する第一歩です。",
			gradient:
				"from-[var(--gradient-positive-1-start)] to-[var(--gradient-positive-1-end)]",
			isMarked: false,
		},
		...
		},
		{
			...
			description:
				"人生の良いことに気づいたとき、その軽さを感じましょう。それが幸せへの道です。",
			gradient:
				"from-[var(--gradient-positive-4-start)] to-[var(--gradient-positive-4-end)]",
			isMarked: false,
		},
