/**
 * Home feature - Main screen with achievement feed
 *
 * Exports:
 * - AchievementHomeScreen: Main home screen component
 * - AchievementHeader: Header with user stats
 * - ChatInputSection: Input section for creating entries
