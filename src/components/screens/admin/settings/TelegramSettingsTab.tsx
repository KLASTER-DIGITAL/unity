  ...
  return (
    <div className="space-y-8">
      ...
      <div className="flex items-center justify-between border-b pb-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-muted-foreground text-sm">Интеграция с Telegram Mini App</p>
          </div>
        </div>
        <Button disabled={isLoading} onClick={testTelegramIntegration} size="sm" variant="outline">
      ...
      <Alert>
        ...
        <AlertDescription>
          UNITY-v2 - это PWA приложение, НЕ Telegram Mini App. Telegram интеграция используется
          только для авторизации через Telegram. Для полноценной работы требуется развернуть Edge
        ...
        <div className="space-y-6 lg:col-span-2">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Текущее состояние Telegram интеграции</CardDescription>
            </CardHeader>
            <CardContent>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Количество пользователей с Telegram авторизацией</CardDescription>
            </CardHeader>
            <CardContent>
              {isLoadingStats ? (
                ...
                <>
                  <div className="mb-4 grid grid-cols-2 gap-4">
                    <div className="rounded-lg border border-blue-200 bg-blue-50 p-4 text-center dark:border-blue-800 dark:bg-blue-950/20">
                      ...
                      <div className="text-muted-foreground text-sm">Всего пользователей</div>
                    </div>
                    <div className="rounded-lg border border-green-200 bg-green-50 p-4 text-center dark:border-green-800 dark:bg-green-950/20">
                      ...
                      <div className="text-muted-foreground text-sm">Через Telegram</div>
                    </div>
                  </div>
                  {telegramStats.lastActivity && (
                    <div className="rounded-lg bg-muted p-3 text-center text-muted-foreground text-sm">
                      Последняя активность:{' '}
                      {new Date(telegramStats.lastActivity).toLocaleString('ru-RU')}
                    </div>
                  )}
                </>
              )}
            ...
            <CardContent className="space-y-4">
              ...
              <Alert>
                ...
                <AlertDescription className="text-sm">
                  Токен бота хранится в переменных окружения Supabase Edge Functions. Для изменения
                  используйте Supabase Dashboard → Edge Functions → Secrets.
                </AlertDescription>
              </Alert>
            </CardContent>
          </Card>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Пошаговое руководство по настройке Telegram интеграции</CardDescription>
        </CardHeader>
        <CardContent>
          <ol className="list-inside list-decimal space-y-4">
            <li className="text-sm">
              ...
              <p className="mt-1 ml-5 text-muted-foreground">
                Используйте @BotFather для создания нового бота. Отправьте команду /newbot и
