  ...
  return (
    ...
    >
      <g clipPath="url(#chrome-path0)">
        ...
        <circle cx="1170" cy="25" r="3" className="fill-[#5F6368] dark:fill-[#9AA0A6]" />
        <circle cx="1170" cy="35" r="3" className="fill-[#5F6368] dark:fill-[#9AA0A6]" />
        <circle cx="1170" cy="15" r="3" className="fill-[#5F6368] dark:fill-[#9AA0A6]" />
