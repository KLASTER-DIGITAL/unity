/**
 * ThemeToggle Component for UNITY-v2
 * Original Sky Toggle from 21st.dev adapted for UNITY-v2
 * Features: Clouds, Stars, Sun/Moon animations, iOS Design System compliance
...
export function ThemeToggle({ className }: ThemeToggleProps) {
	...
	// ✅ FIX: Защита от двойных кликов и быстрых переключений
	...
	return (
		<label className={cn('theme-switch inline-block', className)}>
			<input
