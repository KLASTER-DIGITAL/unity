...
const Card3D = lazy(() =>
	import("../shadcn-io/3d-card").then((module) => ({
		default: module.CardContainer,
	})),
);
const AnimatedModal = lazy(() =>
	import("../shadcn-io/animated-modal").then((module) => ({
		default: module.Modal,
	})),
);
const AnimatedTooltip = lazy(() =>
	import("../shadcn-io/animated-tooltip").then((module) => ({
...
const MagneticButton = lazy(() =>
	import("../shadcn-io/magnetic-button").then((module) => ({
		default: module.MagneticButton,
	})),
);
const MotionHighlight = lazy(() =>
	import("../shadcn-io/motion-highlight").then((module) => ({
		default: module.MotionHighlight,
	})),
);
const ShimmeringText = lazy(() =>
	import("../shadcn-io/shimmering-text").then((module) => ({
		default: module.ShimmeringText,
	})),
);
const Sparkles = lazy(() =>
	import("../shadcn-io/sparkles").then((module) => ({
...
const ColorPicker = lazy(() =>
	import("../shadcn-io/color-picker").then((module) => ({
		default: module.ColorPicker,
	})),
);
const Counter = lazy(() =>
	import("../shadcn-io/counter").then((module) => ({
...
const Terminal = lazy(() =>
	import("../shadcn-io/terminal").then((module) => ({
...
const UILoadingFallback = ({ className = "" }: { className?: string }) => (
	<div
		className={`flex items-center justify-center rounded-lg p-4 ${className}`}
	>
