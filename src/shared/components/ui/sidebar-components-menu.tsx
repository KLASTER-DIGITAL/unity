 ...
 * Defines styling variants for menu buttons
 */
...
/**
 * Sidebar menu button
 * Clickable menu item with optional tooltip
 */
...
/**
 * Sidebar menu action
 * Action button for a menu item (e.g., delete, edit)
 */
...
/**
 * Sidebar menu badge
 * Badge/counter for menu items (e.g., notification count)
 */
