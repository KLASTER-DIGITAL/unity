...
export async function addItem<T>(storeName: string, item: T): Promise<void> {
	...
	return new Promise((resolve, reject) => {
		...
		request.onerror = () => {
			console.error(
				`[IndexedDB] Failed to add item to ${storeName}:`,
				request.error,
			);
			reject(request.error);
		};
...
export async function getItem<T>(
	...
	return new Promise((resolve, reject) => {
		...
		request.onerror = () => {
			console.error(
				`[IndexedDB] Failed to get item from ${storeName}:`,
				request.error,
			);
			reject(request.error);
		};
...
export async function getAllItems<T>(storeName: string): Promise<T[]> {
	...
	return new Promise((resolve, reject) => {
		...
		request.onerror = () => {
			console.error(
				`[IndexedDB] Failed to get all items from ${storeName}:`,
				request.error,
			);
			reject(request.error);
		};
...
export async function updateItem<T>(storeName: string, item: T): Promise<void> {
	...
	return new Promise((resolve, reject) => {
		...
		request.onerror = () => {
			console.error(
				`[IndexedDB] Failed to update item in ${storeName}:`,
				request.error,
			);
			reject(request.error);
		};
...
export async function deleteItem(storeName: string, id: string): Promise<void> {
	...
	return new Promise((resolve, reject) => {
		...
		request.onerror = () => {
			console.error(
				`[IndexedDB] Failed to delete item from ${storeName}:`,
				request.error,
			);
			reject(request.error);
		};
...
export async function getItemsByIndex<T>(
	...
	return new Promise((resolve, reject) => {
		...
		request.onerror = () => {
			console.error(
				`[IndexedDB] Failed to get items by index from ${storeName}:`,
				request.error,
			);
			reject(request.error);
		};
...
export async function clearStore(storeName: string): Promise<void> {
	...
	return new Promise((resolve, reject) => {
		...
		request.onerror = () => {
			console.error(
				`[IndexedDB] Failed to clear store ${storeName}:`,
				request.error,
			);
			reject(request.error);
		};
