...
export const fallbackTranslations: Record<string, Translations> = {
	...
	de: {
		...
		defaultCard1Description:
			"Du hast einen wichtigen Schritt zu deinen Zielen gemacht",
		...
		defaultCard3Description:
			"Deine Anstrengungen werden nicht unbemerkt bleiben",
	...
	fr: {
		...
		defaultCard1Description:
			"Vous avez fait un pas important vers vos objectifs",
