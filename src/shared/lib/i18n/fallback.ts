...
export const fallbackTranslations: Record<string, Translations> = {
	ru: {
		...
		'reports.subtitle': 'Анализ твоих достижений и прогресса',
		'reports.create_report': 'Создать отчет',
		'reports.mood_analysis': 'Анализ настроения',
		'reports.top_categories': 'Топ категории',
		'reports.personal_insights': 'Персональные инсайты',
		'books.status.draft_short': 'Черновик',
		'books.status.ready_short': 'Готово',
		'books.continue_editing': 'Продолжить',
		'books.edit': 'Редактировать',
		'books.editor.header_title': 'Редактор книги',
		'books.editor.header_subtitle': 'Черновик книги',
		'books.photos': 'Фотографии',
		'books.add_photo': 'Добавить',
		'books.editor.save_success_ready': 'Книга сохранена и готова!',
		'books.editor.save_success': 'Изменения сохранены',
		'books.editor.pdf_success': 'PDF книга создана!',
		'books.editor.pdf_error': 'Произошла ошибка при создании PDF',
		'books.editor.pdf_not_available': 'PDF файл недоступен',
		'books.editor.popup_blocked': 'Всплывающее окно заблокировано',
		'books.editor.pdf_open_error': 'Не удалось открыть PDF файл',
		'books.photo_uploaded': 'Фото загружено',
		'books.photo_upload_error': 'Ошибка загрузки фото',
		'books.photo_deleted': 'Фото удалено',
		'books.photo_delete_error': 'Ошибка удаления фото',
		'books.editor.error': 'Произошла ошибка',
		'books.editor.draft_not_found': 'Черновик не найден',
