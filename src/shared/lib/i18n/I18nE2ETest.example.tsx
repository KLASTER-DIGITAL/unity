...
export function I18nE2ETest() {
	...
	const testCompactNotation = () => {
		try {
			const formatted = t.formatCompact(1_234_567);
	...
	return (
		<div className="mx-auto max-w-4xl space-y-6 p-6">
			...
			{/* Test Results */}
			<div className="rounded-lg bg-card p-6 shadow">
				<h2 className="mb-4 font-bold text-xl">Test Results</h2>
			...
			{/* Live Examples */}
			<div className="rounded-lg bg-card p-6 shadow">
				<h2 className="mb-4 font-bold text-xl">Live Examples</h2>
				...
				<div className="space-y-4">
					...
					<div className="border-b pb-4">
						<h3 className="mb-2 font-semibold">Relative Time</h3>
						<p>{t.formatRelativeTime(new Date(Date.now() - 5 * 60 * 1000))}</p>
					</div>

					<div className="border-b pb-4">
						<h3 className="mb-2 font-semibold">Number Formatting</h3>
						<p>{t.formatNumber(1_234_567.89)}</p>
					</div>
