...
describe("Storage Adapter", () => {
	...
	describe("StorageUtils", () => {
		it("should store and retrieve JSON object", async () => {
			...
			const retrieved =
				await StorageUtils.getJSON<typeof testObject>("test_json");
	...
	describe("StorageKeys", () => {
		it("should have all required storage keys defined", async () => {
			...
			expect(StorageKeys.NOTIFICATIONS_ENABLED).toBe(
				"unity_notifications_enabled",
			);
			expect(StorageKeys.ONBOARDING_COMPLETED).toBe(
				"unity_onboarding_completed",
			);
...
describe("Navigation Adapter", () => {
	...
	describe("NavigationUtils", () => {
		it("should have all required routes defined", async () => {
			const { NavigationUtils } = await import(
				"@/shared/lib/platform/navigation"
			);
...
describe("Animation Adapter", () => {
	...
	describe("AnimatedPresence", () => {
		it("should be defined and exportable", async () => {
			const { AnimatedPresence } = await import(
				"@/shared/lib/platform/animation"
			);
	...
	describe("Animation Hooks", () => {
		it("should export useAnimationState hook", async () => {
			const { useAnimationState } = await import(
				"@/shared/lib/platform/animation/hooks"
			);
